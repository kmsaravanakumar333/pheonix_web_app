  ...
  return (
    <div>
      <div className='banner'>
        We create creative web apps <br /> and mobile apps
        <p className='subtitle'>We are committed to providing our customers with
          exceptional service</p>
        <NavLink className="nav-link navbar-brand" to="/contact-us" style={{ textAlign: 'center' }}>
      ...
      <div className='who-are-we'>
        ...
        <div class="row align-items-center">
          <div class="col-sm-12 col-md-6 px-5 py-3 subtitle-1">
            We are Web and Mobile Application development company that started off with a vision, to help every organization to grow as a business while helping them automate their business processes. Our combination of modern and practical designs is what distinguishes us from the others.
          </div>
          ...
          <div class="col card-col">
            <div class="card" style={{ width: '15rem', height: '10rem' }}>
              <div className='card-content'>
                ...
                <div class="card-body">
                  <p class="card-text">Analysis and
                    Re-engineering</p>
                </div>
              </div>
            </div>
      ...
      {/* <div className='title-1 py-3'>What Our Clients Say
        About Us.</div> */}
      <div className='title-1 py-3'>HAVE ANY QUESTIONS ?</div>
      <div class="container text-center">
        <div class="row align-items-start">
          <div class="col card-col">
            <div class="card card-1" style={{ width: '15rem', height: '10rem' }}>
              <div className='card-content'>
          ...
          <div class="col card-col">
            <div class="card card-1" style={{ width: '15rem', height: '10rem' }}>
              <div className='card-content'>
                ...
                <div class="card-body">
                  <p class="card-text">pheonixsoftwaresolutions1009@gmail.com</p>
                </div>
              </div>
            </div>
          </div>
      ...
      <div style={{ fontWeight: '500', paddingLeft: '3rem', marginBottom: '1rem' }}>Send us a message!</div>
      <div class="row align-items-start">
        <div class="col card-col">
          <div style={{ width: '50rem', margin: '0 3rem' }}>
            <div>
              <div className='d-flex justify-content-around'>
                <div class="mb-3 col-md-5 col-sm-12" style={{ marginRight: '4rem' }}>
        ...
        <div class="col card-col">
          <img src={fullLogo} alt='' style={{ height: '21rem', marginTop: '-4rem' }} />
        </div>
      </div>
